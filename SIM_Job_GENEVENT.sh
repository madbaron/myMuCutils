...
#sed 's/OUTFILENAME/"\/dataMuC\/sim\/'${2}'\/'${2}'_sim_'${1}'.slcio"/g' sim_EVENT_${1}.py > sim_EVENT_${1}_temp.py
#mv  sim_EVENT_${1}_temp.py sim_EVENT_${1}.py
#sed 's/STEPSIZE/'${3}'/g' sim_EVENT_${1}.py > sim_EVENT_${1}_temp.py
#mv  sim_EVENT_${1}_temp.py sim_EVENT_${1}.py

ddsim --steeringFile sim_EVENT_${1}.py --inputFiles /dataMuC/gen/${2}/${2}_gen.slcio --numberOfEvents ${3} --skipNEvents ${1} --outputFile /dataMuC/sim/${2}/${2}_sim_${1}.slcio
